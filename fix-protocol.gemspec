...
Gem::Specification.new do |s|
  ...
  s.authors     = ['Rize engineering team']
  s.email       = ['engineering@rizemoney.com']
  s.homepage    = 'https://github.com/RizeFinance/rize-fix-protocol'
  ...
  Rize fork changes version to FIX 4.2 and adds a few more message types
  EOS
